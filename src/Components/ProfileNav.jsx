    ...
    <>
        ...
        <div className='row justify-content-center'>
            <div className='col-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12'>
                ...
                <NavLink className="nav-link" to="/home" aria-current="page"><div className='rounded-pill'><IoHomeSharp className='mt-1 add_btn_animation' style={{fontSize:"27px"}}></IoHomeSharp></div></NavLink>
