...
function Videos() {
  ...
  useEffect(() => {
   ...
   // State to track successful upload
   ...
   useEffect(() => {
    ...
    if (!storedUser) {
      ...
      if (uid) {
        setIsLoading(true);
        firebase.AllAudios(uid)
          .then((products) => {
            setVideos(products.docs);
            setIsLoading(false);
  ...
  return (
    ...
    {backonline && (
      ...
      <div className='container-fluid scrollable-Home  mt-3 mb-5'>
      < Navup/>
      <Navbar/>
      {isLoading ? (
          ...
          <div className='row d-flex justify-content-center mt-2  g-4'>
          <GoBack></GoBack>
          {Videos.length > 0 ?(Videos.map((Video) => (
              <AudioCard  key={Video.id} id={Video.id} {...Video.data()} />
                      ...
                      <div className="col-md-12 col-12 mx-auto">
                        <div className="mb-5 p-2">
                          <div className="p-2 mt-2 mb-1 col-md-12 col-lg-12 col-xl-12  d-flex justify-content-between">
                            <div>
                              <h2 className="mt-2 ms-2">Add Audios</h2>
                            </div>
                          </div>
                        </div>
                      </div>
